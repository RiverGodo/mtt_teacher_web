...
const AddCase = () => import('../views/cases-manage/case-theory/add-case')
...
const createCase = () => import('../views/cases-manage/case-warehouse/create-case')
const CaseTheory = () => import("../views/cases-manage/case-theory")
const TheoryBase = () => import("../views/cases-manage/case-theory/theory-base")
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'case-theory',
                name: 'case-theory',
                component: CaseTheory
            },
            {
                path: 'theory-base',
                name: 'theory-base',
                component: TheoryBase
            },
            {
                path: 'add-case',
                name: 'add-case',
