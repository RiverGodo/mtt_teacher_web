    ...
    <div class="case-head">
        ...
        <div class="case-head-pers" @click="seePatientInfo">
            <div style="display: table-caption">
                <!-- <img class="case-head-img" src="http://sfile.9mededu.com/production/20191114131117.png" alt="头像" /> -->
        ...
        <div class="head-details" v-if="isPersonal">
            ...
            <p class="head-details-per" v-if="isShowTitle">
                <span class="white-regular4">{{title2}}：{{patientData.title}}</span>
                <span style="margin-left: 50px" class="white-regular4">{{title}}用时：{{patientData.use_time}}</span>
            </p>
...
export default {
    ...
    computed: {
        ...
        title2(){
            return this.type == 1 ? '病例名称' : this.type == 2 ? '考试标题' : this.type == 3 ? '作业标题' : '学习'
        },
        scoreUrl(){
