    ...
    export default {
        ...
        data() {
            return {
                ...
                case_type: [
                    {color: '#A1CDFF', fill_color: '#A1CDFA', title: '问诊', short_title: '问诊'},
                    {color: '#60CFD7', fill_color: '#60CFD7', title: '体格检查', short_title: '体检'},
                    {color: '#FFC058', fill_color: '#FFC058', title: '辅助检查', short_title: '辅检'},
                    {color: '#9BDD4A', fill_color: '#9BDD4A', title: '治疗', short_title: '治疗'},
                    {color: '#BB91FE', fill_color: '#BB91FE', title: '鉴别要素', short_title: '鉴别要素'},
                    {color: '#E08049', fill_color: '#E08049', title: '病种', short_title: '病种'},
                ],
                add_type: [
        ...
        methods: {
            ...
            signNode(val) {
                if (this.evt.item._cfg.model.fill == val.fill_color) {
                    ...
                    this.evt.item._cfg.model.stroke = '#ABB7C5' || val.color
                }
                this.updateGraph()
                this.$refs.case_menu.style.left = '-150px'
            },
