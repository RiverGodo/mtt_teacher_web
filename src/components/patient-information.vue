        ...
        <div class="patient-modal-main">
          <div class="patient-modal-Left">
            ...
            <div class="patient-left-info">
              ...
              <div class="patient-left-item"><span>民族：{{patientData.nation}}</span></div>
          ...
          <div class="patient-modal-content">
              ...
              <div class="patient-content-item"><span class="patient-content-tilte">病情描述：</span><span class="patient-content-details">{{patientData.cardinal_symptom}}</span></div>
              ...
              <div class="patient-content-item"><span class="patient-content-tilte">就诊时间：</span><span class="patient-content-details">{{patientData.add_time}}</span></div>
          </div>
        </div>
    </Modal>
</template>
