...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            logout() {
                api.post('v1/user/logout').then((res) => {
            ...
            setMenuActive() {
                ...
                this.menuList = roleId == 3 ? MenuList.slice(0, MenuList.length-1) : roleId == 4 ? [MenuList[4]] : MenuList
                if(roleId == 4) {
                    ...
                    this.activeIndex = (JSON.stringify(MenuList)).includes(this.$route.name) ? this.$route.name : menuActive
        ...
        mounted() {
            ...
            //  }).then(() => {
                 this.setMenuActive()
            //  })
            $MenuActiveIndex.$on('MenuActiveIndex', (val) => {
                if(this.$route.name != 'data-management'){
                    if(val == 'exam-manage') this.activeIndex = 'exam-manage'
                    if(val == 'case-warehouse') {
                        this.activeIndex = 'case-warehouse'
                        this.menuOpenName = ["case-manage"]
                        this.refreshMenu()
                    }
                }
