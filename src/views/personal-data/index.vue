          ...
          <Form ref="formValidate" class="personal-form" :model="formValidate" :rules="ruleValidate" :label-width="80">
            ...
            <FormItem prop="sex" >
                ...
                <Select v-model="formValidate.sex" placeholder="请选择性别">
                  <Option :value="2">女</Option><Option :value="1">男</Option>
                </Select>
            </FormItem>
            <FormItem prop="phone" >
            ...
            <FormItem label="账号密码" prop="password" >
              <div v-if="passType == 1" class="changepass">
                  <Input type="password" disabled v-model="formValidate.password" placeholder="请输入账号密码"></Input>
                  <Button @click="changPass()" style="margin-left: 10px;" type="primary">修改密码</Button>
              </div>
              <div v-else class="changepass">
...
<script>
 ...
 export default {
    ...
    methods: {
      handleSubmit(name){
        ...
        let d = {
          ...
          head_img:this.formValidate.head_img
        }
        this.preservation(name, d,'/v1/user/modifyAdmin')
      },
    ...
    mounted() {
      ...
      this.oldPass = this.formValidate.password
      this.formValidate.password = "////////"
    }
  }
</script>
