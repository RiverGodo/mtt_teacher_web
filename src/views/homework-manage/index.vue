<template>
    <div class="user-manage-main">
        ...
        <div class="screen">
            ...
            <Select @on-change="selectChange2" class="select-list" v-model="homework_state">
            ...
            <Button style="margin-right: 20px;" @click="handleClick()" type="primary">创建作业</Button>
        </div>
        <Table :columns="columns1" :data="list">
            <template slot-scope="{ row, index }" slot="operation">
                <div class="action">
                    <span @click="seeModal(row,index)" class="see">查看</span>
                    <span @click="edit(row,index)" v-if="row.homework_state == 0 " class="nosee">编辑</span>
    ...
    export default {
        ...
        data (){
            return{
                ...
                organization_id: "all",
                select2: [{title: '全部状态', id: 'all'},{title: '未开始', id: 1},{title: '已开始', id: 2}, {title: '已结束', id: 3}],
        ...
        methods: {
            ...
            getList(){
                let d = {
                    ...
                    state: this.homework_state == "all" ? null : this.homework_state
                }
                postData('/v1/homework/getHomeworkList', d).then((res) => {
