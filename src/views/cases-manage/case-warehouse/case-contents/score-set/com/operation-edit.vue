    ...
    <div class="container">
        ...
        <div class="operation-edit-content">
            <div v-if="type == 'talk'" class="content-talk">
                <div class="talk-box">
                    <div>提问</div>
                    <Input :disabled="isCheck" v-model="content.question" class="talk-input" />
                </div>
                <div class="talk-box">
                    <div>回答</div>
                    <Input :disabled="isCheck" v-model="content.answer" class="talk-input" type="textarea" :rows="4"/>
                </div>
            </div>
            <div class="physicals" v-if="type == 'physical'">
                ...
                <div class="physicals-content">
                    <Input :disabled="isCheck" v-model="content.result_text"  style="width: 440px;" type="textarea" :rows="4"/>
                    <div v-if="!isCheck" class="file-type">* 支持jpg/png图片、mp3音频、mp4/mov/avi视频，且大小不超过300M，只能上传多个同类型文件</div>
                    <div class="right-content-btn">
                        <div style="width: 300px;">
                            <div v-for="(item, index) in upload_file" :key="index" class="file_item" >
                                ...
                                <Icon v-if="!isCheck" class="upload-delete" @click="deleteUpload(index)" type="ios-close" size="20"/>
                            </div>
                        </div>
                        <upload-btn v-if="!isCheck" text="上传文件" class="content-btn-up" bucket="jhyl-static-file" type="image/jpeg,image/png,image/jpg,video/mp4,video/mov,audio/mpeg "
            ...
            <div v-if="type == 'assist'">
                ...
                <div v-if="!isCheck" class="upload-hint">* 支持jpg/png图片、mp3音频、mp4/mov/avi视频，大小不超过300M,只能上传一个文件</div>
                <div v-if="content.type == 'ImageData'" style="margin: 2px 20px 0 20px;" class="right-content-btn">
                    <div :class="media&&media.media_name ? 'show-media' : 'hide-media'" style="width: 300px;">
                        <div class="file_item" >
                            ...
                            <Icon v-if="!isCheck" class="upload-delete" @click="deleteMediaUpload" type="ios-close" size="20"/>
                        </div>
                    </div>
                    <upload-btn v-if="!isCheck" text="上传文件" class="content-btn-up" type="application/* "
                ...
                <div v-else class="upload-mold">
                    ...
                    <div v-for="(item, index) in assisTable" class="mold-content" :key="index">
                        <img v-if="!isCheck" class="content-img" :src="deleteImg" alt="" @click="deleteTable(index)">
                        <div style="display: flex;">
                            <Input :disabled="isCheck" v-model="item[item1.model]" v-for="(item1, index1) in mold_head" :key="index1"
                                   class="content-edit"
            ...
            <div class="phy-item" v-else>
                ...
                <Input :disabled="isCheck" v-model="content.deduct_reason"  style="width: 440px;margin-left: 10px" type="textarea" :rows="4"/>
            </div>
        </div>
        ...
        methods: {
            ...
            Interrogation(){
                let da = {
                    ...
                    frequency_id: this.content.frequency_id
                }
                let d = {
                    ...da,
            ...
            setEdit(t, it, support) {
                ...
                this.thirdName = it.third_name
                this.upload_file = it.media || []
                this.media = it.media || {}
                this.assisTable = it.media || []
                this.actItem = it
                this.diagnosessData = t
                this.fileType = it.result_media_type
            },
            addTable() {
