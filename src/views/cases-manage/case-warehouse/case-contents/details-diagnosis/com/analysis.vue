<template>
    <div class="analysis">
        ...
        <div v-else class="analysis-content">
            ...
            <Input :disabled="isCheck" v-model="treatment_principle" type="textarea" :rows="8" placeholder="请输入处置原则" />
            <div class="title title2">诊疗建议</div>
            <Input :disabled="isCheck" v-model="suggestion"  type="textarea" :rows="8" placeholder="请输入诊疗建议" />
    ...
    export default {
        ...
        methods: {
             add(){
                 ...
                 PostData('/v1/case/modifyTreatmentDisposition', d).then((r) => {
                     if(r&&r.res_code == 1) {
