<template>
    <div class="main">
        <div class="tabs-view-score tabs-content" :style="`width: ${casePane == 2&&page<4 ? '1061px' : '561px' }`">
            <Tabs @on-click="tabs" v-model="casePane" type="line" size="small" :class="page == 5 ? 'tabs5' : 'tabs'">
                <TabPane name="1" :label="title[page - 1]">
                   <OperationLeft v-if="casePane == 1" @changeShow="changeShow" @changeState="changeState" :type="page" pane="essential1" />
                </TabPane>
        ...
        <div class="content let-content" v-show="casePane == 1">
            ...
            <opertionEdit v-show="showOpertionEdit" @changeShow="changeShow" @changeState="changeState" :typePane="page"/>
            <TreatmentRight :type="page" :show="show" @changeShow="changeShow" @changeState="changeState" v-show="showTreatmentRight" />
        </div>
    </div>
</template>
...
<script>
    ...
    import TreatmentRight from './treatment-right.vue'

    export default {
        components: { unscramble, OperationLeft, ScoreDetails, opertionEdit, TreatmentRight },
        props: {
            page: {
                type: String,
                default: '',
...
<style lang="less" scoped>
    @import '../components/details.less';
    .tabs-view-score{
        height: 647px;
    }
