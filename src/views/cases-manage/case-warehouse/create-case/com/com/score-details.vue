...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setClass(it){
                if(it.is_exist || this.isCheck) return 'disabled-content-detail'
                else return (it.id === this.activeId || it.first_id === this.activeId)  ? 'act-content' : 'de-content'
            },
            getListUrl(){
                return ['case/getTalkTreeForScore', 'case/getPhysicalFirstItemForScore', 'case/getAssistFirstItemForScore', 'case/getFirstListByTab'][this.tabs - 1]
            },
            getTalkUrl(){
                return ['case/getTalkTreeForScore', 'case/getPhysicalResultListForScore', 'case/getAssistResultListForScore', 'case/getListByType'][this.tabs - 1]
            },
