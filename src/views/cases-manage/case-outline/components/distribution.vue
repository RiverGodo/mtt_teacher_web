        ...
        <div class="main">
            <div style="display: flex">
                <div class="item">
                    ...
                    <!-- <Tables :highlightRow="true" style="width: 100%;" :tabel-height="tableHeight"  :column="columns1" :table-data="list" @row-click="rowClick" /> -->
                    <Table @on-row-click="rowClick" :height="tableHeight" style="width: 100%;" :columns="columns1" :data="list"></Table>
            ...
            comparison(){
                if(this.list2.length>0){
                    ...
                    this.list2.forEach(element => {
                        teacherid.push(element.id)
                    });
                    let data = {
                        distribution_user_id: teacherid[0],
                        outline_id:this.outline_id
                    }
                    PostData('/v1/outline/distributionOutline', data).then(res => {
                        if(res.res_code == 1) {
                            this.close()
