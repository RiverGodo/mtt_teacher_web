<template>
    <div class='dashboard-view'>
        ...
        <div v-if="viewMax" class='col-container'>
             <router-view style="width: 100%;" :key="$route.fullPath" />
        </div>
        <div v-else class="col-container">
            <div  v-if="menushow" :style="widthStyle" class='menu-bar'>
                <side-menu/>
            </div>
            <div class='menu-bar-false' v-else>
                <HideMenu :stateClasses="hideClass"/>
            </div>
            <div class='sub-view' :style="viewStyl">
